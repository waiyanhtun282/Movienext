...
const HomeComodies = ({movie}:trendType) => {
    // const arr=Array(20).fill("");
  return (
    <div className=" container mx-auto ">
    <div className=" my-5">
      <h1 className=" font-semibold text-3xl text-white uppercase">Comodies</h1>
          ...
          <SwiperSlide key={item?.id}>
            <div className=" my-5 overflow-hidden">
              <div className="   relative">
                <Image src={imagePath + item?.poster_path} alt={`Comodies ${item?.title || item?.id}`} width={350} height={350} className="z-0  cursor-pointer  hover:scale-125 duration-300" />
