...
const HomeDocummetries = ({movie}:trendType) => {
    // const arr=Array(20).fill("");
  return (
    <div className=" container mx-auto ">
    <div className=" my-5">
      <h1 className=" font-semibold text-3xl text-white uppercase">DoucummEtries </h1>
              ...
              <div className="   relative">
                ...
                <div className=" absolute bottom-2 z-20  left-4">
                  ...
                  <div className=" flex items-center gap-3">
                    ...
                    <p className="  text-gray">Voted movie</p>
                  </div>
                </div>
              </div>
            </div>
...
export default HomeDocummetries;
