...
const HomeTopRated = ({movie}:trendType) => {
    // const arr=Array(20).fill("");
    // console.log(movie);
  return (
    <div className=" container mx-auto ">
    <div className=" my-5">
      <h1 className=" font-semibold text-3xl text-white uppercase">Top Rated</h1>
          ...
          <SwiperSlide key={item?.id}>
            <div className=" my-5 overflow-hidden ">
              <div className="   relative">
                <Image src={imagePath + item?.poster_path} alt={`toprated ${item?.id || item?.title} `} width={350} height={350} className="z-0  cursor-pointer hover:scale-125 duration-300" />
