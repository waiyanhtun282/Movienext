...
const HomeAction = ({movie}:trendType) => {
    const arr=Array(20).fill("");
  return (
    <div className=" container mx-auto ">
    <div className=" my-5">
      <h1 className=" font-semibold text-3xl text-white uppercase">Action</h1>
          ...
          <SwiperSlide key={item?.id}>
            <div className=" my-5 overflow-hidden">
              <div className="   relative">
                <Image src={imagePath + item?.poster_path} alt={item?.name || item?.title} width={350} height={350} className="z-0  cursor-pointer  hover:scale-125 duration-300" />
                ...
                <div className=" absolute bottom-2 z-20  left-4">
                  ...
                  <div className=" flex items-center gap-3">
                    ...
                    <p className="  text-gray">Action movie</p>
                  </div>
                </div>
              </div>
            </div>
